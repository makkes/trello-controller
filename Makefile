...
.PHONY: artifact-push
artifact-push:
	flux push artifact oci://ghcr.io/makkes/manifests/trello-controller:$(IMG_TAG) --path=./config/ --source=https://github.com/makkes/trello-contriller --revision=$(IMG_TAG)/$(shell git rev-parse HEAD)
